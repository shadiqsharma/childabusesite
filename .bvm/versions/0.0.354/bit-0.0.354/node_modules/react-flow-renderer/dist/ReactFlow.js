...
var ZoomPane = function (_a) {
    var onMove = _a.onMove, onMoveStart = _a.onMoveStart, onMoveEnd = _a.onMoveEnd, _b = _a.zoomOnScroll, zoomOnScroll = _b === void 0 ? true : _b, _c = _a.panOnScroll, panOnScroll = _c === void 0 ? false : _c, _d = _a.panOnScrollSpeed, panOnScrollSpeed = _d === void 0 ? 0.5 : _d, _e = _a.panOnScrollMode, panOnScrollMode = _e === void 0 ? exports.PanOnScrollMode.Free : _e, _f = _a.zoomOnDoubleClick, zoomOnDoubleClick = _f === void 0 ? true : _f, selectionKeyPressed = _a.selectionKeyPressed, elementsSelectable = _a.elementsSelectable, _g = _a.paneMoveable, paneMoveable = _g === void 0 ? true : _g, _h = _a.defaultPosition, defaultPosition = _h === void 0 ? [0, 0] : _h, _j = _a.defaultZoom, defaultZoom = _j === void 0 ? 1 : _j, translateExtent = _a.translateExtent, children = _a.children;
...
var FlowRenderer = function (_a) {
    ...
    return (React__default['default'].createElement(ZoomPane, { onMove: onMove, onMoveStart: onMoveStart, onMoveEnd: onMoveEnd, selectionKeyPressed: selectionKeyPressed, elementsSelectable: elementsSelectable, zoomOnScroll: zoomOnScroll, panOnScroll: panOnScroll, panOnScrollSpeed: panOnScrollSpeed, panOnScrollMode: panOnScrollMode, zoomOnDoubleClick: zoomOnDoubleClick, paneMoveable: paneMoveable, defaultPosition: defaultPosition, defaultZoom: defaultZoom, translateExtent: translateExtent },
        children,
        ...
        propElements.forEach(function (el) {
            ...
            if (storeElementIndex !== -1) {
                ...
                if (isNode(storeElement)) {
                    ...
                    if (positionChanged) {
                        state.elements[storeElementIndex].__rf.position = propNode.position;
                    }
                    if (typeChanged) {
