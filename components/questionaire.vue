  ...
  <div>
    <header class="vff-header">
      <div class="f-container">
        ...
        <img src="static/img/ChildAbuseHelpLogo.png" alt="ChildAbuseHelpLogo" class="f-logo">
      </div>
    </header>
    ...
    return {
      ...
      questions: [
        ...
        new QuestionModel({
          ...
          options: [
            new ChoiceOption({
              imageSrc: require('static/img/facebook.png'),
              imageAlt: 'Facebook logo',
              label: 'Facebook'
            }),
            new ChoiceOption({
              imageSrc: require('static/img/twitter.png'),
              imageAlt: 'Twitter logo',
              label: 'Twitter'
            }),
            new ChoiceOption({
              imageSrc: require('static/img/instagram.png'),
              imageAlt: 'Instagram logo',
              label: 'Instagram'
            }),
            new ChoiceOption({
              imageSrc: require('static/img/tiktok.png'),
