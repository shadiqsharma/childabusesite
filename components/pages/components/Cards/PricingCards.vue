            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    <card type="pricing" color="green">
                        ...
                        <ul>
                            <li><i class="now-ui-icons ui-1_check text-success"></i> Unlimited MB</li>
                            <li><i class="now-ui-icons ui-1_check text-success"></i> Unlimited emails</li>
                            <li><i class="now-ui-icons ui-1_check text-success"></i> Unlimited Databases</li>
                            <li><i class="now-ui-icons ui-1_check text-success"></i> Full Support</li>
                        </ul>
