            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8 mr-auto ml-auto">
                        ...
                        <h4 class="description text-white">Trello’s boards, lists, and cards enable you to organize and prioritize your projects in a fun, flexible and rewarding way.</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p class="description text-white">Whether it’s for work or even the next family vacation, Trello helps your team.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p class="description text-white">Integrate the apps your team already uses directly into your workflow.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p class="description text-white">No matter where you are, Trello stays in sync across all of your devices.</p>
                        </div>
                    </div>
                </div>
            </div>
