                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="image-container image-left"
                                ...
                                <p class="blockquote blockquote-success">"Amber Interiors is available to assist in all
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="image-container image-left"
                                ...
                                <p class="blockquote blockquote-success">"We provide a simple, approachable way to
